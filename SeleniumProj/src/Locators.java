...
public class Locators {
	...
	public static void main(String[] args) throws InterruptedException {
        ...
        driver.findElement(By.id("inputUsername")).sendKeys("radhi");
        driver.findElement(By.name("inputPassword")).sendKeys("hello");
        driver.findElement(By.className("signInBtn")).click();
        System.out.println(driver.findElement(By.cssSelector("p.error")).getText());
        driver.findElement(By.linkText("Forgot your password?")).click();
        //Thread.sleep(1000); //intercepted error to get stable state
        driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("John");
        driver.findElement(By.cssSelector("input[placeholder='Email']")).sendKeys("John1@rsa.com");
        ...
        Thread.sleep(1000);
        driver.findElement(By.cssSelector("#inputUsername")).sendKeys("radhi");
